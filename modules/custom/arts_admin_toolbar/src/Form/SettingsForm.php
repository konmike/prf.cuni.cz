...
namespace Drupal\arts_admin_toolbar\Form;

/**
 * @file
 * Contains \Drupal\arts_admin_toolbar\Form\SettingsForm.
 */
...
class SettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'arts_admin_toolbar_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['arts_admin_toolbar.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('arts_admin_toolbar.settings');
